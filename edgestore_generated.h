...
#ifndef FLATBUFFERS_GENERATED_EDGESTORE_MYGAME_SAMPLE_H_
#define FLATBUFFERS_GENERATED_EDGESTORE_MYGAME_SAMPLE_H_
...
inline flatbuffers::Offset<EdgeStore> CreateEdgeStoreDirect(
  ...
  return MyGame::Sample::CreateEdgeStore(
      _fbb,
...
inline flatbuffers::Offset<EdgeStoreEntry> CreateEdgeStoreEntryDirect(
  ...
  return MyGame::Sample::CreateEdgeStoreEntry(
      _fbb,
      key,
      value ? _fbb.CreateVector<int64_t>(*value) : 0);
}

inline const MyGame::Sample::EdgeStore *GetEdgeStore(const void *buf) {
  return flatbuffers::GetRoot<MyGame::Sample::EdgeStore>(buf);
}

inline const MyGame::Sample::EdgeStore *GetSizePrefixedEdgeStore(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<MyGame::Sample::EdgeStore>(buf);
}

inline bool VerifyEdgeStoreBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<MyGame::Sample::EdgeStore>(nullptr);
}

inline bool VerifySizePrefixedEdgeStoreBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<MyGame::Sample::EdgeStore>(nullptr);
}

inline void FinishEdgeStoreBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<MyGame::Sample::EdgeStore> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_EDGESTORE_MYGAME_SAMPLE_H_
